let musicas = [
    {titulo:'Guitar solo', artista:'João Tinti', source:'#', img:'#'},
    {titulo:'Samba raiz', artista:'Bossa Nova Brasil', source:'#', img:'#'},
    {titulo:'Música piano', artista:'John Green', source:'#', img:'#'},
    {titulo:'Música piano', artista:'John Green', source:'#', img:'#'},
    {titulo:'Música piano', artista:'John Green', source:'#', img:'#'}
];
